...
pub fn get_root(leaves: &LeavesArray) -> [u8;32] {
    ...
    while size > 1 {
      for i in 0..size/2 {
        next[i] = hashv(Parameters::Bn254X5, Endianness::BigEndian, &[&level[2*i], &level[2*i+1]]).unwrap().to_bytes();
      }
...
pub const DEPTH_ONE:   [u8;32] = [ 32,152,245,251,158, 35,158,171, 60,234,195,242,123,129,228,129,220, 49, 36,213, 95,254,213, 35,168, 57,238,132, 70,182, 72,100 ];
pub const DEPTH_TWO:   [u8;32] = [ 16,105,103, 61,205,177, 34, 99,223, 48, 26,111,245,132,167,236, 38, 26, 68,203,157,198,141,240,103,164,119, 68, 96,177,241,225 ];
pub const DEPTH_THREE: [u8;32] = [ 24,244, 51, 49, 83,126,226,175, 46, 61,117,141, 80,247, 33,  6, 70,124,110,234, 80, 55, 29,213, 40,213,126,178,184, 86,210, 56 ];
...
pub const DEPTH_EIGHT: [u8;32] = [ 47,165,229,241,143, 96, 39,166, 80, 27,236,134, 69,100, 71, 42, 97,107, 46, 39, 74, 65, 33, 26, 68, 76,190, 58,153,243,204, 97 ];
pub const DEPTH_NINE:  [u8;32] = [ 14,136, 67,118,208,216,253, 33,236,183,128, 56,158,148, 31,102,228, 94,122,204,227,226, 40,171, 62, 33, 86,166, 20,252,215, 71 ];
pub const DEPTH_TEN:   [u8;32] = [ 27,114,  1,218,114, 73, 79, 30, 40,113,122,209,165, 46,180,105,249, 88,146,249, 87,113, 53, 51,222, 97,117,229,218, 25, 10,242 ];
pub const DEPTH_ELEVEN:[u8;32] = [ 31,141,136, 34,114, 94, 54, 56, 82,  0,192,178,  1, 36,152, 25,166,230,225,228,101,  8,  8,181,190,188,107,250,206,125,118, 54 ];
pub const DEPTH_TWELVE:[u8;32] = [ 44, 93,130,246,108,145, 75,175,185,112, 21,137,186,140,252,251, 97, 98,176,161, 42,207,136,168,208,135,154,  4,113,181,248, 90 ];
pub const DEPTH_THIRTEEN:[u8;32]=[ 20,197, 65, 72,160,148, 11,184, 32,149,127, 90,223, 63,161, 19, 78,245,196,170,161, 19,244,100,100, 88,242,112,224,191,191,208 ];
pub const DEPTH_FOURTEEN:[u8;32]=[ 25, 13, 51,177, 47,152,111,150, 30, 16,192,238, 68,216,185,175, 17,190, 37, 88,140,173,137,212, 22, 17,142, 75,244,235,232, 12 ];
pub const DEPTH_FIFTEEN:[u8;32]=[ 34,249,138,169,206,112, 65, 82,172, 23, 53, 73, 20,173,115,237, 17,103,174,101,150,175, 81, 10,165,179,100,147, 37,224,108,146 ];
pub const DEPTH_SIXTEEN:[u8;32]=[ 42,124,124,155,108,229,136, 11,159,111, 34,141,114,191,106, 87, 90, 82,111, 41,198,110,204,238,248,183, 83,211,139,186,115, 35 ];
pub const DEPTH_SEVENTEEN:[u8;32]=[ 46,129,134,229, 88,105,142,193,198,122,249,193, 77, 70, 63,252, 71,  0, 67,201,194,152,139,149, 77,117,221,100, 63, 54,185,146 ];
pub const DEPTH_EIGHTEEN:[u8;32]=[ 15, 87,197, 87, 30,154, 78,171, 73,226,200,207,  5, 13,174,148,138,239,110,173,100,115,146, 39, 53, 70, 36,157, 28, 31,241, 15 ];
pub const DEPTH_NINETEEN:[u8;32]=[ 24, 48,238,103,181,251, 85, 74,213,246, 61, 67,136,128, 14, 28,254,120,227, 16,105,125, 70,228, 60,156,227, 97, 52,247, 44,202 ];
pub const DEPTH_TWENTY:[u8;32]=[ 33, 52,231,106,197,210, 26,171, 24,108, 43,225,221,143,132,238,136, 10, 30, 70,234,247, 18,249,211,113,182,223, 34, 25, 31, 62 ];
